...
class Cart extends Component {
    ...
    generateBill=()=>{
        ...
        var doc = jsPDF('p', 'pt')
        doc.text(20, 30, "You need to pay : " + total + " " + " " + " " + " " + " " + " " + "||" + " " + " " + " " + " " + " " + " " + " " +"Thank you for shopping")
        const cart = this.props.cart
        const cartRow = cart.map((val,index) => {
            doc.text(40 + index, 60 * index, "Prodcut Name:" + " " + val.name + " " + "||" + " " + "Prodcut price:" + " " + val.price + " " + "||" + " "+ "Prodcut Quantity:" + " " + val.quant)
            this.setState({
    ...
    render() {
        return (
            <div className="cart" id="cart">
                <h2>Cart <button onClick={this.closeCart}> X </button></h2>
                <hr/>
                {this.renderCart()}
                <hr/>
                <div className="cart-footer">
                    <h3>Total Rs. <span id="total"> </span></h3>
